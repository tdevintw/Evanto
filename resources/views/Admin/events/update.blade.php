                    ...
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-md-12 my-4">
                                <h2 class="h4 mb-1">Edit Event</h2>
                                <p class="mb-3">here you can Edit the platform's events</p>
                                <div style="display:flex;flex-direction:flex;justify-content:center">
                                    <form style="width:50%" action="{{ route('events.update',$event->id) }}" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="width:50%" value="{{$event->title}}" name="title" type="text" class="form-control"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="width:50%" value="{{$event->description}}" name="description" type="text"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="width:50%" value="{{$event->tickets}}" name="tickets" type="number"  class="form-control"
                                                id="exampleInputEmail1" aria-describedby="emailHelp"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input value="{{$event->image}}" style="width:50%" name="image" type="file" class="form-control"
                                                id="exampleInputEmail1" aria-describedby="emailHelp"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input value="{{$event->location}}" style="width:50%" name="location" type="text" class="form-control"
                                                id="exampleInputEmail1" aria-describedby="emailHelp"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input value="{{$event->date}}" style="width:50%" name="date" type="datetime-local"
                                                class="form-control" id="exampleInputEmail1"
                                        ...
                                        <div class="form-group" style="display: flex ; gap:5px">
                                            <label for="exampleInputEmail1">Reserve Method:</label>                                         
                                                ...
                                                <input class="form-check-input" type="radio" name="reserve_method"
                                                    id="exampleRadios1" value="default" checked>
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="reserve_method"
                                                        id="exampleRadios2" value="request" checked>
                                                    <label class="form-check-label" for="exampleRadios2">
                                                        Request
                                                    </label>
                                                </div>
