                    ...
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-md-12 my-4">
                                ...
                                <p class="mb-3">here you can Add the platform's categories</p>
                                <div style="display:flex;flex-direction:flex;justify-content:center">
                                    <form  style="width:50%" action="{{route('categories.store')}}" method="post">
                                        @csrf
                                        <div class="form-group">
                                          <label for="exampleInputEmail1">Catgeory</label>
                                          <input style="width:50%" name="name" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Category">
                                        </div>
                                        @if ($errors->any())
                                        <div class="text-center">
                                            <ul>
                                                @foreach ($errors->all() as $error)
                                                   <p style="width:fit-content">{{ $error }}</p> 
                                                @endforeach
                                            </ul>
                                        </div>
                                       @endif
