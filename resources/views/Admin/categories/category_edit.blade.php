                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 my-4">
                                ...
                                <div style="display:flex;flex-direction:flex;justify-content:center">
                                    <form  style="width:50%" action="{{route('categories.update',$category->id)}}" method="post">
                                        @csrf
                                        @method('PUT')
                                        <div class="form-group">
                                          <label for="exampleInputEmail1">Catgeory</label>
                                          <input style="width:50%" name="name" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$category->name}}">
                                        </div>
                                        @if ($errors->any())
